...
struct EnhancedEmojiKeyboard: DemoKeyboard {
    ...
    init(in viewController: KeyboardViewController) {
        ...
        gridConfig = HFloatingHeaderButtonCollectionView.Configuration(headerSize: CGSize(width: 200, height: 30), itemSize: CGSize(width: 48, height: 48), rowsCount: rowsPerPage, titleColor: nil, titleFont: nil)
